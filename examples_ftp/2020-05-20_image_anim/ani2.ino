...
void setup() {
	...
	TFTscreen.drawFastHLine(20, 20, 120,COLOR_GREEN);
	TFTscreen.drawFastHLine(20, 51, 42,COLOR_GREEN);
	TFTscreen.drawFastHLine(98, 51, 42,COLOR_GREEN);
	
	TFTscreen.drawFastVLine(62, 51, 26,COLOR_GREEN);
	TFTscreen.drawFastVLine(98, 51, 26,COLOR_GREEN);
	
	TFTscreen.drawFastHLine(20, 77, 42,COLOR_GREEN);
	TFTscreen.drawFastHLine(98, 77, 42,COLOR_GREEN);
	TFTscreen.drawFastHLine(20, 108, 120,COLOR_GREEN);
...
void bar(){
	static int imagePosX=20,imagePosY=23,imageOldPosX=20;
	const int imageWidth=30,imageHeight=26;
	currentMillis=millis();	
	if(currentMillis-previousMillisBar>250){
		...
		switch(barstate){
			case bar0:
				...
				if(imagePosX != imageOldPosX){	//erase left part of the image
					TFTscreen.fillRect(imageOldPosX, imagePosY, incX, 26, COLOR_BLACK);
				}
				imageOldPosX=imagePosX;	
				if(imagePosX<=120-imageWidth/2){
					imagePosX+=incX;
				}else{
					int a=5;
				}
